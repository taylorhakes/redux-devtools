...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createDevStore = __webpack_require__(2);

	var _createDevStore2 = _interopRequireDefault(_createDevStore);

	var _reduxDevtoolsSrcReact = __webpack_require__(3);
	...
	var store = _createDevStore2['default'](function (action) {
	...
	_react2['default'].render(_react2['default'].createElement(_reduxDevtoolsSrcReact.DevTools, { monitor: _reduxDevtoolsSrcReact.LogMonitor, store: store }), document.getElementById('root'));
...
/***/ function(module, exports) {
	...
	exports["default"] = createDevToolsStore;

	function createDevToolsStore(onDispatch) {
		var currentState = {
			committedState: {},
			stagedActions: [],
			computedStates: [],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createDevTools = __webpack_require__(160);
	...
	var _LogMonitor = __webpack_require__(186);

	exports.LogMonitor = _interopRequire(_LogMonitor);

	var _DebugPanel = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactReduxLibComponentsCreateAll = __webpack_require__(161);
	...
	var _devTools = __webpack_require__(185);
	  ...
	  return (function (_Component) {
	    ...
	    function DevTools(props, context) {
	      ...
	      this.renderRoot = function () {
	        return React.createElement(Connector, null, _this.renderMonitor);
	      };
	    ...
	    DevTools.prototype.render = function render() {
	      ...
	      return React.createElement(Provider, { store: devToolsStore }, this.renderRoot);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createConnectDecorator = __webpack_require__(171);
	    ...
	    return function (DecoratedComponent) {
	      return (function (_Component) {
	        ...
	        ProviderDecorator.prototype.render = function render() {
	          ...
	          return React.createElement(Provider, { store: store }, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqualScalar = __webpack_require__(172);
	...
	function createConnectDecorator(React, Connector) {
	  ...
	  return function connect(_select) {
	    return function (DecoratedComponent) {
	      return (function (_Component) {
	        ...
	        ConnectorDecorator.prototype.render = function render() {
	          ...
	          return React.createElement(Connector, { select: function select(state) {
	              return _select(state, _this.props);
	            } }, function (stuff) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsComposeMiddleware = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMapValues = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsPick = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _composeMiddleware = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LogMonitorEntry = __webpack_require__(187);
	...
	var LogMonitor = (function () {
	  ...
	  LogMonitor.prototype.render = function render() {
	    ...
	    return _react2['default'].createElement('div', { style: {
	      ...
	      style: { textDecoration: 'underline', cursor: 'hand' } }, 'Sweep')), computedStates.length > 1 && _react2['default'].createElement('span', null, _react2['default'].createElement('span', null, ' • '), _react2['default'].createElement('a', { onClick: this.handleCommit.bind(this),
	      style: { textDecoration: 'underline', cursor: 'hand' } }, 'Commit'))));
	  };
	...
	var LogMonitorEntry = (function () {
	  ...
	  LogMonitorEntry.prototype.render = function render() {
	    ...
	    return _react2['default'].createElement('div', { style: {
	      ...
	      } }, _react2['default'].createElement('a', { onClick: this.handleActionClick.bind(this),
	      style: {
	      ...
	      } }, JSON.stringify(action)), !collapsed && _react2['default'].createElement('p', { style: {
	        textAlign: 'center',
	        transform: 'rotate(180deg)'
	      } }, '⇧'), !collapsed && _react2['default'].createElement('div', { style: {
	        paddingBottom: '1em',
	        paddingTop: '1em',
	        color: 'lightyellow'
	      } }, this.printState(state, error)), _react2['default'].createElement('hr', { style: {
	        marginBottom: '2em'
	      } }));
	  };
